<?php $pageTitle = 'Contact Us - TIBST'; $activePage = 'contact'; require_once 'includes/header.php'; ?>
          ...
          <div style="display:flex; flex-direction:column; gap:24px; margin-bottom:32px;">
            <div style="display:flex; gap:16px; align-items:flex-start;">
              ...
              <div>
                ...
                <p style="color:#666;">Constellations Avenue, Lashibi, Accra, Ghana</p>
              </div>
            </div>
            ...
            <div style="display:flex; gap:16px; align-items:flex-start;">
              ...
              <div>
                ...
                <p style="color:#666;"><a href="tel:+233302957663">+233 302 957 663</a></p>
                <p style="color:#666;"><a href="tel:+233277715058">+233 277 715 058</a> (Mobile)</p>
              </div>
            </div>
            ...
            <div style="display:flex; gap:16px; align-items:flex-start;">
              ...
              <div>
                ...
                <p style="color:#666;"><a href="mailto:info@thrivusinstitute.edu.gh">info@thrivusinstitute.edu.gh</a></p>
              </div>
            </div>
          </div>

          <!-- WhatsApp Button -->
          <a href="https://wa.me/233277715058" target="_blank" class="btn btn-primary" style="width:100%; background:#25D366; border-color:#25D366; margin-bottom:32px; display:flex; align-items:center; justify-content:center; gap:10px;">
